...
def start(update: Update, context: CallbackContext) -> int:
    ...
    update.message.reply_text(f'Привет, {user.first_name}! Здесь ты сможешь посмотреть перевод песен группы Metallica.\n'
                              'Выбери альбом, а затем песню:', reply_markup=get_album_keyboard())
    return ALBUM

# Клавиатура для выбора альбома
def get_album_keyboard() -> ReplyKeyboardMarkup:
    albums = [['Альбом - Kill Em All'], ['Альбом - Ride the Lightning'], ['Альбом - Master of Puppets'], ['Альбом - And Justice for All'], ['Альбом - Metallica'], ['Альбом - Load'], ['Альбом - ReLoad'], ['Альбом - S&M'], ['Альбом - St Anger'], ['Альбом - Death Magnetic'], ['Альбом - Beyond Magnetic'], ['Альбом - Hardwired To Self-Destruct'], ['Альбом - 72 Seasons'], ['Singles'], ['Exit']]
...
def select_album(update: Update, context: CallbackContext) -> int:
    ...
    if album == 'Exit':
        ...
        # Удаляем префикс "Альбом -" из выбранного альбома
        album = album.replace('Альбом - ', '')
        context.user_data['album'] = album
        update.message.reply_text(f'Выбран альбом: {album}\n'
                                  'Теперь выбери песню:', reply_markup=get_song_keyboard(album))
        return SONG
...
def get_song_keyboard(album: str) -> ReplyKeyboardMarkup:
    ...
    if album == 'Kill Em All':
        songs = [['Hit the Lights'], ['The Four Horsemen'], ['Motorbreath'], ['Jump in the Fire'], ['Anesthesia'], ['Whiplash'], ['Phantom Lord'], ['No Remorse'], ['Seek and Destroy'], ['Metal Militia']]
        ...
        songs = [['Enter Sandman'], ['Sad but True'], ['Holier Than Thou'], ['The Unforgiven'], ['Wherever I May Roam'], ['Dont Tread on Me'], ['Through the Never'], ['Nothing Else Matters'], ['Of Wolf and Man'], ['The God That Failed'], ['My Friend of Misery'], ['The Struggle Within']]
    elif album == 'Load':
        songs = [['Aint My Bitch'], ['2 X 4'], ['The House Jack Built'], ['Until It Sleeps'], ['King Nothing'], ['Hero of the Day'], ['Bleeding Me'], ['Cure'], ['Poor Twisted Me'], ['Wasting My Hate'], ['Mama Said'], ['Thorn Within'], ['Ronnie'], ['The Outlaw Torn']]
    elif album == 'ReLoad':
        songs = [['Fuel'], ['The Memory Remains'], ['Devils Dance'], ['The Unforgiven II'], ['Better than You'], ['Slither'], ['Carpe Diem Baby'], ['Bad Seed'], ['Where the Wild Things Are'], ['Prince Charming'], ['Low Mans Lyric'], ['Attitude'], ['Fixxxer']]
    elif album == 'S&M':
        songs = [['Human'], ['No Leaf Clover']]
    elif album == 'St Anger':
        songs = [['Frantic'], ['St Anger'], ['Some Kind of Monster'], ['Dirty Window'], ['Invisible Kid'], ['My World'], ['Shoot Me Again'], ['Sweet Amber'], ['The Unnamed Feeling'], ['Purify'], ['All Within My Hands']]
    elif album == 'Death Magnetic':
        songs = [['That Was Just Your Life'], ['The End of the Line'], ['Broken, Beat and Scarred'], ['The Day That Never Comes'], ['All Nightmare Long'], ['Cyanide'], ['The Unforgiven III'], ['The Judas Kiss'], ['Suicide and Redemption'], ['My Apocalypse']]
        ...
        songs = [['Hardwired'], ['Atlas, Rise!'], ['Now That Were Dead'], ['Moth into Flame'], ['Dream No More'], ['Halo on Fire'], ['Confusion'], ['ManUNkind'], ['Here Comes Revenge'], ['Am I Savage?'], ['Murder One'], ['Spit Out the Bone']] 
    elif album == '72 Seasons':
        songs = [['72 Seasons'], ['Shadows Follow'], ['Screaming Suicide'], ['Sleepwalk My Life Away'], ['You Must Burn!'], ['Lux Eterna'], ['Crown of Barbed Wire'], ['Chasing Light'], ['If Darkness Had a Son'], ['Too Far Gone?'], ['Room of Mirrors'], ['Inamorata']] 
    elif album == 'Singles':
        songs = [['I Disappear']]   
    songs.append(['Back'])
...
def select_song(update: Update, context: CallbackContext) -> None:
    ...
    if song == 'Back':
        ...
        update.message.reply_text(f"Перевод песни '{song}' из альбома '{album}' на русский язык:\n{translation}",
